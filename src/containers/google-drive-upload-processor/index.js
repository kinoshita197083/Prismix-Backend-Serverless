...
const { handler: googleDriveUploadProcessor } = require('./src/handlers/imageUploader');
...
const app = Consumer.create({
    ...
    handleMessage: async (message) => {
        try {
            ...
            await googleDriveUploadProcessor(event);
    ...
    batchSize: 2,  // Process one message at a time initially
